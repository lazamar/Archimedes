var Geo = (function(){
  ...
  function getCoords(coord){
    ...
    locationObj.lat = coord.coords.latitude;
    locationObj.lon = coord.coords.longitude;
    getWeather(locationObj.lat, locationObj.lon)
  ...
  function getWeather(lat, lon){
    ...
    request.get(weatherUrl, function (error, jsonresponse, body){
